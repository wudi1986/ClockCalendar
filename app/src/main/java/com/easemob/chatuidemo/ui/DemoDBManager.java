...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(ClockApplication.getInstance().getApplicationContext());
    }
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(EasemobConstant.NEW_FRIENDS_USERNAME) || username.equals(EasemobConstant.GROUP_USERNAME)
                        || username.equals(EasemobConstant.CHAT_ROOM)|| username.equals(EasemobConstant.CHAT_ROBOT)) {
