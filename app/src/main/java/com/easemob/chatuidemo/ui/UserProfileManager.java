...
import com.easemob.chatuidemo.ui.DemoHelper.DataSyncListener;
...
public class UserProfileManager {
		...
		ParseManager.getInstance().asyncGetCurrentUserInfo(new EMValueCallBack<EaseUser>() {
			...
			public void onSuccess(EaseUser value) {
			    if(value != null){
    				...
    				Log.e("bbb", "value.getNick() ================ "+value.getNick());
    				Log.e("bbb", "value.getAvatar() ================ "+value.getAvatar());
			    }
			}
	...
	public void setCurrentUser(String nickname, String avatar){
		setCurrentUserNick(nickname);
