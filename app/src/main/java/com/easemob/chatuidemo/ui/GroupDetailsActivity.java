...
public class GroupDetailsActivity extends EaseBaseActivity implements OnClickListener {
    ...
    private TextView groupDetailsTitleName,groupDetailsTitlePeopleNum;
    String userID;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Tools.getLog(Tools.d,"aaa", "st====="+st);
		...
		groupDetailsTitleName = (TextView) findViewById(R.id.groupDetailsTitleName);
		groupDetailsTitlePeopleNum = (TextView) findViewById(R.id.groupDetailsTitlePeopleNum);
        ...
        groupDetailsTitleName.setText(group.getGroupName());
        groupDetailsTitlePeopleNum.setText(group.getAffiliationsCount()+"人");
        
//		((TextView) findViewById(R.id.group_name)).setText(group.getGroupName() + "(" + group.getAffiliationsCount() + st);
        Tools.getLog(Tools.d,"aaa", "stdasdadasdasd====="+group.getGroupName() + "(" + group.getAffiliationsCount() + st);
...
//			break;
	...
	private void toggleBlockGroup() {
		if(switchButton.isSwitchOpen()){
			Tools.getLog(Tools.d,TAG, "change to unblock group msg");
			if (progressDialog == null) {
		        progressDialog = new ProgressDialog(GroupDetailsActivity.this);
		        progressDialog.setCanceledOnTouchOutside(false);
		    }
			...
			Tools.getLog(Tools.d,TAG, "change to block group msg");
			if (progressDialog == null) {
		        progressDialog = new ProgressDialog(GroupDetailsActivity.this);
		        progressDialog.setCanceledOnTouchOutside(false);
		    }
...
//								return;
//							}
//							Tools.getLog(Tools.d,"group", "remove user from group:" + username);
...
//						} else {
						...
						if (userID.equals(username)) {
							Intent in = new Intent(GroupDetailsActivity.this, ClockMyActivity.class);
							
							GroupDetailsActivity.this.startActivity(in);
						} else {
							Intent in = new Intent(GroupDetailsActivity.this, ClockOtherUserActivity.class);
...
//									+ st);//")"
							...
							// update block
							Tools.getLog(Tools.d,TAG, "group msg is blocked:" + group.getMsgBlocked());
