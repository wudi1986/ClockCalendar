...
public class ContextMenuActivity extends EaseBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    if(message.getBooleanAttribute(EasemobConstant.MESSAGE_ATTR_IS_VIDEO_CALL, false) ||
		            message.getBooleanAttribute(EasemobConstant.MESSAGE_ATTR_IS_VOICE_CALL, false)){
		        setContentView(R.layout.em_context_menu_for_location);
		    }else if(message.getBooleanAttribute(EasemobConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
