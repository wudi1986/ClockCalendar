...
public class CrashHandler implements UncaughtExceptionHandler ,ServiceListener{
	...
	public void uncaughtException(Thread thread, Throwable ex) {
		if (!handleException(ex) && mDefaultHandler != null) {
			...
			System.exit(0);
//			ClockApplication.getInstance().exit();
		}
	}
	  ...
	  private String getVersionName() throws Exception
	   {
	           ...
	           PackageInfo packInfo = packageManager.getPackageInfo(ClockApplication.getInstance().getPackageName(),0);
	...
	public void collectDeviceInfo(Context ctx) {
		...
		for (Field field : fields) {
			try {
				...
				Tools.getLog(Tools.i,  TAG, field.getName() + " : " + field.get(null));
			} catch (Exception e) {
