...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int currentPosition = 0;//默认的选择
	private int selectedPosition = 0;//默认的选择
	...
	private int tabPadding = 17;//每条的左右内边距原24
	private int dividerWidth = 1;

	private int tabTextSize = 12;
	private int selectTabTextSize = 14;
...
//					GroupMainFragmentActivity.mEditor.commit();
	...
	//	public boolean addBadgeView(int count,boolean isShow){
	//		
	//		badgeView.setText(count+"");
	//		badgeView.setTextColor(Color.WHITE);
	//		badgeView.setBadgeBackgroundColor(Color.RED);
	//		badgeView.setTextSize(12);
	////		view.setGravity(Gravity.TOP|Gravity.RIGHT);
	...
	//			isVisibility = false;
	//		}else if(badgeView.getVisibility() == View.VISIBLE){
	//			isVisibility = true;
	//		}
	//		updateTabStyles();
	//		return isVisibility;
...
//				System.out.println("i"+i+"selectedPosition"+selectedPosition);
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			switch (position) {//聊天
			case 0:
				//				MainMenuFragmentActivity.mType.setVisible(true);

				break;
			case 1:
				//				TCAgent.onEvent(getContext(), "henhua_wode");
				//				MainMenuFragmentActivity.mType.setVisible(false);
				break;
			case 2:
				//				TCAgent.onEvent(getContext(), "henhua_xiaoxi	");
				//				MainMenuFragmentActivity.mType.setVisible(false);
				//				addBadgeView(0, false);
...
//					GroupMainFragmentActivity.mEditor.commit();
	...
	/** 是否显示 小红点*/
	public void setRedVisity(boolean isVisity){
		isAlertVisibility = isVisity;
		updateTabStyles();
	}
	/** 获得小红点状态*/
	public boolean  RedVisity(){
		return isAlertVisibility;
	}
	...
	public void setSelectTextSice(int textSizePx){
		selectTabTextSize = textSizePx;
		updateTabStyles();
	}
