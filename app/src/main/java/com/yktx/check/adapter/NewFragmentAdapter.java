...
//		holdView.attention_fragment_item_imageStick.setVisibility(View.GONE);//图片
        ...
        holdView.readcard_fragment_item_takeClockNumImage.setImageResource(R.drawable.guangchang_zuixin_renshu);
        ...
        if (singnature != null && singnature.length() != 0) {
            ...
            holdView.attention_fragment_item_clockContent
                    .setText(Tools.trim(ToDBC(singnature)));
            holdView.attention_fragment_item_clockContent
                    .setVisibility(View.VISIBLE);
        } else {
...
//				context.startActivity(in);
    ...
    public class HoldView {
        ...
        ImageView attention_fragment_item_headImage,
                ...
                readcard_fragment_item_takeClockNumImage,
        ...
        public HoldView(View convertView) {
            ...
            readcard_fragment_item_takeClockNumImage = (ImageView) convertView
                    .findViewById(R.id.readcard_fragment_item_takeClockNumImage);
