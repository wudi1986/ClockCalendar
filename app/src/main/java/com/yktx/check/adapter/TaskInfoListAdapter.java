...
public class TaskInfoListAdapter extends RecyclerView.Adapter<TaskInfoListAdapter.ChildHolder> {
...
//	ChartMeteringView chartMeteringView;
    ...
    public TaskInfoListAdapter(Activity mContext, String thisJobUserID) {
...
//		chartMeteringView = new ChartMeteringView(mContext);
    ...
    public ChildHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ChildHolder holder = new ChildHolder(LayoutInflater.from(
                mContext).inflate(R.layout.tast_info_listview_item, parent,
                false));
        return holder;
    }
    ...
    public void ShowView(final ChildHolder holdView,
                         final int childPosition) {
        boolean isblankVisity;

        final TaskItemBean taskItemBean = itemBeans.get(childPosition);
        //为了区分是不是这一天最后一条
        if (childPosition == (itemBeans.size())) {
        ...
        holdView.group_right.setText("Day");
        String curTitle = TimeUtil.getYYMMDD(taskItemBean.getCheck_time());
//        if(!titleDate.equals(curTitle)) {
        holdView.groupLayout.setVisibility(View.VISIBLE);
        holdView.textView.setVisibility(View.VISIBLE);
        holdView.group_right.setVisibility(View.VISIBLE);
        titleDate = curTitle;
        holdView.textView.setText(curTitle
                .substring(5));
//        } else {
//            holdView.groupLayout.setVisibility(View.GONE);
//        }
        ...
        if (Give_up_flag.equals("0")) {
            if (ClockContent != null && ClockContent.length() != 0) {
                ...
                holdView.taskItem_Content.setText(Tools.trim(ToDBC(ClockContent)));
            ...
            if (Give_up_reason != null) {
                holdView.taskItem_Content.setText(Tools.trim(ToDBC(Give_up_reason)));
                holdView.taskItem_Content.setVisibility(View.VISIBLE);
            } else {
                //				holdView.taskItem_Content.setVisibility(View.GONE);
                holdView.taskItem_Content.setText("打卡1次");
        ...
        holdView.taskItem_moreImage.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                upFlagClick.setGiveUp(childPosition);
            }
        });
    ...
    class ChildHolder extends RecyclerView.ViewHolder {
        ...
        public ChildHolder(View v) {
            ...
            group_right = (TextView) v
                    .findViewById(R.id.day);
            groupLayout = (LinearLayout) v
    ...
    public interface TaskInfoOnClick {
         ...
         * 点击评论
         */
        public void clickComment(TaskItemBean taskItemBean,
