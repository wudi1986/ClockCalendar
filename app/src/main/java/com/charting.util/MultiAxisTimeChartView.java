...
//
//	public MultiAxisTimeChartView(Context context,
//			ArrayList<JobStatsBean> JobStatsBeanList, String startTime,
//			String stopTime) {
//		super(context);
//		// TODO Auto-generated constructor stub
//		this.JobStatsBeanList = JobStatsBeanList;
//		this.startTime = getStringForStartTime(startTime);
//		this.stopTime = getStringForStopTime(stopTime);
//		getDayMaxNum();
//		initChart();
//	}
//
//	/**
//	 * string 字符串，返回double数据
//	 */
//	private int getStringForStartTime(String time) {
//		String strArray[] = time.split(":");
//		return Integer.parseInt(strArray[0]);
//		// double minute = Double.parseDouble(strArray[1])*100/60;
//
//	}
//
//	/**
//	 * string 字符串，返回double数据
//	 */
//	private double getStringForTime(long time) {
//
...
//		double hour = Double.parseDouble(strArray[0]);
//		double minutes = Double.parseDouble(strArray[1]);
//		minutes = minutes / 60;
//		return hour + minutes;
//	}
//
...
//	 * string 字符串，返回double数据
//	 */
//	private int getStringForStopTime(String time) {
//		String strArray[] = time.split(":");
//		int minutes;
//		minutes = Integer.parseInt(strArray[1]);
//		if (minutes == 0) {
//			return Integer.parseInt(strArray[0]);
//		} else {
//			return Integer.parseInt(strArray[0]) + 1;
//		}
//		// double minute = Double.parseDouble(strArray[1])*100/60;
//
//	}
...
//				String array[] = JobStatsBeanList.get(i).getQuantity()
//						.split(",");
...
//				}
//			}
//			if (JobStatsBeanList.get(i).getCheckTime() != null) {
//				String array[] = JobStatsBeanList.get(i).getCheckTime()
//						.split(",");
//				int length = array.length;
//				if (array.length > maxCheckTimeCount) {
//					maxCheckTimeCount = length;
//				}
//			}
//		}
//
...
//			JobStatsBean bean = isHaveBean(date);
//			if (bean == null) {
...
//		// }
//
//		LinkedList[] listArray = new LinkedList[maxCheckTimeCount];
//
//		for (int i = 0; i < maxCheckTimeCount; i++) {
//			listArray[i] = new LinkedList<Double>();
//		}
//
//		for (int i = 0; i < chartLabels.size(); i++) {
...
//			JobStatsBean bean = isHaveBean(date);
//			if (bean == null) {
//				for (int j = 0; j < maxCheckTimeCount; j++) {
//					listArray[j].add(0d);
//				}
//			} else {
//				if (bean.getQuantity() != null) {
//					String array[] = bean.getCheckTime().split(",");
//					for (int j = 0; j < maxCheckTimeCount; j++) {
//
//						if (j < array.length) {
//							long curTime = Long.parseLong(array[j]);
//							Tools.getLog(Tools.i, "aaa", "getStringForTime(curTime) ============ "+getStringForTime(curTime));
//							listArray[j].add(getStringForTime(curTime));
//						} else {
//							listArray[j].add(0d);
//						}
//					}
...
//
//		// 将标签与对应的数据集分别绑定
//		// LineData lineData1 = new LineData("", virtual, Color.rgb(234, 83,
//		// 71));
...
//		// 75, 166, 51));
//		LineData[] LineDataArray = new LineData[maxQuantityCount];
//		for (int j = 0; j < maxQuantityCount; j++) {
//			if (j > 0) {
//				LineDataArray[j] = new LineData("", listArray[j], 0x00000000);
//			} else {
//				LineDataArray[j] = new LineData("", listArray[j], Color.rgb(
//						250,115,80));
//			}
//			LineDataArray[j].setDotStyle(XEnum.DotStyle.DOT);
//			LineDataArray[j].getDotPaint().setColor(Color.rgb(250,115,80));
//
//			chartDataLn.add(LineDataArray[j]);
//		}
//
...
//	}
//
//	private JobStatsBean isHaveBean(String date) {
//		for (int i = 0; i < JobStatsBeanList.size(); i++) {
...
//
//		// 范围时间小时得数量
//		int offTime = (int) (stopTime - startTime);
//
//		if (offTime < 3) {
//			if (startTime == 0) {
//				dataAxis.setAxisMin(startTime);
//			} else {
//				dataAxis.setAxisMin(startTime - 1);
//			}
//
//			if (stopTime == 24) {
//				dataAxis.setAxisMax(stopTime);
//			} else {
//				dataAxis.setAxisMax(stopTime + 1);
//			}
//			dataAxis.setAxisSteps(1);
//		} else {
//			int steps = (int) (offTime / 6) == 0 ? 1 : offTime / 6;
//			int index = offTime % steps == 0 ? offTime / steps : offTime
//					/ steps + 1;
//			dataAxis.setAxisMax(steps * index);
//			dataAxis.setAxisSteps(steps);
//			dataAxis.setAxisMin(startTime);
//		}
//		// int steps = (int) (offTime / 4);
//		// int index = maxJobCount % steps == 0 ? maxJobCount / steps
//		// : maxJobCount / steps + 1;
//		// dataAxis.setAxisMax(steps * index);
//		// dataAxis.setAxisSteps(steps);
//		//
