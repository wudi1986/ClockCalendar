...
//
//	public CloudTagManager(Context context, AttributeSet attrs, int defStyle) {
//		super(context, attrs, defStyle);
//		init();
//	}
//
//	public CloudTagManager(Context context, AttributeSet attrs) {
//		super(context, attrs);
//		init();
//	}
//
//	public CloudTagManager(Context context) {
//		super(context);
//		init();
//	}
//
...
//				continue;
//			}
//			LayoutParams layParams = (LayoutParams) txt
//					.getLayoutParams();
